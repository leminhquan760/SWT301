            ...
            <div class="col-md-4">
                <form action="" method="post">
                    <div class="add-note-fields">
                        <h4>Title</h4>
                        <input class="form-control" name="title" placeholder="A short text" type="text">
                    </div>
                    <div class="add-note-fields">
                        <h4>Details</h4>
                        <textarea class="form-control" name="details" rows="3" placeholder="A long text"></textarea>
                    </div>
                    <div class="add-note-fields">
                        <h4>Due date</h4>
                        <input class="form-control" name="dueDate" type="date">
                    </div>
                    <button class="btn-green" name="btnInsertNote" type="submit">
